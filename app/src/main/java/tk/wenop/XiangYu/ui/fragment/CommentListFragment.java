...
import tk.wenop.XiangYu.adapter.custom.RecentCommentListAdapter;
...
public class CommentListFragment extends Fragment  {
    ...
    RecentCommentListAdapter recentCommentListAdapter;
...
//            mParam2 = getArguments().getString(ARG_PARAM2);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        recentCommentListAdapter = new RecentCommentListAdapter(getActivity());
        recentCommentListAdapter.putDatas(DBManager.instance(getActivity()).getAllRecentComment());

        User user = BmobUser.getCurrentUser(getActivity(), User.class);
//        AreaNetwork.loadFollowAreas(getActivity(), this, user);
        listView.setAdapter(recentCommentListAdapter);
    }
