...
import tk.wenop.XiangYu.ui.LocationActivity;
...
public class MainScreen_MessageChatAdapter extends BaseListAdapter<BmobMsg> {
    ...
    //语音+附图
    private final int TYPE_SEND_MS_VOICE_with_IMAGE = 8;
    private final int TYPE_RECEIVER_MS_VOICE_with_IMAGE = 9;
    ...
    public MainScreen_MessageChatAdapter(Context context, List<BmobMsg> msgList) {
    ...
    public int getItemViewType(int position) {
        ...
        // TODO: wenop-add : 如何定制 “语音+附图”这样的形式
    }
    ...
    private View createViewByType(BmobMsg message, int position) {
       ...
       if(type==BmobConfig.TYPE_IMAGE){//图片类型
            return getItemViewType(position) == TYPE_RECEIVER_IMAGE ?
                    ...
                    mInflater.inflate(R.layout.item_chat_ms_sent_voice_with_image, null);
